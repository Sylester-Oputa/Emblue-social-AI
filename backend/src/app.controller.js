...
var AppController = function () {
    ...
    var AppController = _classThis = /** @class */ (function () {
        function AppController_1(prisma) {
    ...
    (function () {
        ...
        _health_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)(), (0, swagger_1.ApiOperation)({ summary: 'Liveness check' })];
        _ready_decorators = [(0, public_decorator_1.Public)(), (0, common_1.Get)('ready'), (0, swagger_1.ApiOperation)({ summary: 'Readiness check with service statuses' })];
