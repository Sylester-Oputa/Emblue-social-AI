            ...
            switch (_a.label) {
                ...
                case 1:
                    ...
                    swaggerConfig = new swagger_1.DocumentBuilder()
                        ...
                        .setDescription(process.env.SWAGGER_DESCRIPTION || 'Compliance-first social engagement API')
                ...
                case 2:
                    _a.sent();
                    console.log("\uD83D\uDE80 Emblue Social AI running on http://localhost:".concat(port));
